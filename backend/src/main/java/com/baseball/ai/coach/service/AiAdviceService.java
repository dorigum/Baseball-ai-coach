    ...
    public String generateTacticalAdvice(AdviceRequestDto dto) {
        String systemInstructions = """
            ...
            1. 분석 시점은 항상 사용자의 구단인 **myTeam (기준 구단)** 기준이어야 합니다.
               - **myTeam이 공격 중일 때** (타자 소속 팀이 myTeam인 경우): 타자가 상대 투수의 구속/구종과 수비 시프트를 뚫고 출루/득점하기 위한 구체적인 타격 공략법 및 주루 전략을 조언하십시오.
               - **myTeam이 수비 중일 때** (투수 소속 팀이 myTeam인 경우): 투수와 야수가 상대 타자의 약점을 공략해 아웃카운트를 효과적으로 잡기 위한 투구 위치 전략 및 수비 시프트 운용 지침을 조언하십시오.
